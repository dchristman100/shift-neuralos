...
export default function MasterExport() {
  ...
  const handleFullSiteExport = async () => {
    ...
    singleA.download = "ShiFtNeuralOS-BrandHome-v4.html";
    singleA.click();
...
`);
    ...
    zipA.href = zipUrl;
    zipA.download = "ShiFtNeuralOS-AllPages-v4.zip";
    zipA.click();
  ...
  const pageGroups = [
   ...
   Copy the full page export at /ExportRevenueEnginePlans -->` }] },
    ...
    // ── CONVERT NAV PAGES ──
    {
      ...
      color: "#F54A48", dotColor: "#F54A48", exportPagePath: "HowItWorks",
      badge: "Convert Nav · 3 stages: Capture → Qualify → Book",
      sections: [{ id: "how-it-works-full", title: "How It Works — Full Page HTML", exportPagePath: "HowItWorks", items: [{ label: "HTML", code: HOW_IT_WORKS_HTML }] }],
    },
    {
      title: "Convert: Revenue Leaks (/RevenueLeaks)",
      color: "#F54A48", dotColor: "#FA982F", exportPagePath: "RevenueLeaks",
      badge: "Convert Nav · 3 leaks: Missed Calls + Junk Leads + Invisible Buyers",
      sections: [{ id: "revenue-leaks-full", title: "Revenue Leaks — Full Page HTML", exportPagePath: "RevenueLeaks", items: [{ label: "HTML", code: REVENUE_LEAKS_HTML }] }],
    },
    {
      title: "Convert: Results — Titan Case Study (/Results)",
      color: "#F54A48", dotColor: "#48BB78", exportPagePath: "Results",
      badge: "Convert Nav · $750K → $7M · Jake Torres · Dallas TX",
      sections: [{ id: "results-full", title: "Results / Case Study — Full Page HTML", exportPagePath: "Results", items: [{ label: "HTML", code: RESULTS_HTML }] }],
    },
    // ── ATTRACT NAV PAGES ──
    {
      title: "Attract: How It Works (/AttractHowItWorks)",
      color: "#FA982F", dotColor: "#FA982F", exportPagePath: "AttractHowItWorks",
      badge: "Attract Nav · 30-Day Pipeline Build Timeline",
      sections: [{ id: "attract-how-it-works-full", title: "Attract How It Works — Full Page HTML", exportPagePath: "AttractHowItWorks", items: [{ label: "HTML", code: ATTRACT_HOW_IT_WORKS_HTML }] }],
    },
    {
      title: "Attract: Empty Pipeline (/AttractEmptyPipeline)",
      color: "#FA982F", dotColor: "#FA982F", exportPagePath: "AttractEmptyPipeline",
      badge: "Attract Nav · 3 Problems: Inconsistent Leads + Bad Marketing + Referral Dependency",
      sections: [{ id: "attract-empty-pipeline-full", title: "Attract Empty Pipeline — Full Page HTML", exportPagePath: "AttractEmptyPipeline", items: [{ label: "HTML", code: ATTRACT_EMPTY_PIPELINE_HTML }] }],
    },
    {
      title: "Attract: Results (/AttractResults)",
      color: "#FA982F", dotColor: "#FA982F", exportPagePath: "AttractResults",
      badge: "Attract Nav · 147% lead increase · $47 avg cost per lead · 4.2× ROI",
      sections: [{ id: "attract-results-full", title: "Attract Results — Full Page HTML", exportPagePath: "AttractResults", items: [{ label: "HTML", code: ATTRACT_RESULTS_HTML }] }],
    },
    // ── NEURALAOS NAV PAGES ──
    {
      title: "Platform (/Platform)",
      color: "#FFD700", dotColor: "#FFD700", exportPagePath: "Platform",
      badge: "NeuralOS Nav · Neural Stack 4 layers + capabilities",
      sections: [{ id: "platform-full", title: "Platform — Full Page HTML", exportPagePath: "Platform", items: [{ label: "HTML", code: PLATFORM_HTML }] }],
    },
    {
      title: "Roofing (/Roofing)",
      color: "#FFD700", dotColor: "#FA982F", exportPagePath: "Roofing",
      badge: "NeuralOS Nav · Residential + Commercial + Storm + Multi-Location",
      sections: [{ id: "roofing-full", title: "Roofing — Full Page HTML", exportPagePath: "Roofing", items: [{ label: "HTML", code: ROOFING_HTML }] }],
    },
    // ── FOOTER PAGES: PRODUCT ──
    {
      title: "Features (/Features)",
      color: "#48BB78", dotColor: "#48BB78", exportPagePath: "Features",
      badge: "Footer: Product · 8 platform features with stats",
      sections: [{ id: "features-full", title: "Features — Full Page HTML", exportPagePath: "Features", items: [{ label: "HTML", code: FEATURES_HTML }] }],
    },
    {
      title: "Integrations (/Integrations)",
      color: "#48BB78", dotColor: "#63B3ED", exportPagePath: "Integrations",
      badge: "Footer: Product · CRM + Calendar + Comms + Ads + Workflow",
      sections: [{ id: "integrations-full", title: "Integrations — Full Page HTML", exportPagePath: "Integrations", items: [{ label: "HTML", code: INTEGRATIONS_HTML }] }],
    },
    {
      title: "Case Studies (/CaseStudies)",
      color: "#48BB78", dotColor: "#48BB78", exportPagePath: "CaseStudies",
      badge: "Footer: Product · Interactive filters + recharts (static card version included)",
      sections: [{ id: "case-studies-full", title: "Case Studies — Full Page HTML (Static version, 3 cards)", exportPagePath: "CaseStudies", items: [{ label: "HTML", code: CASE_STUDIES_HTML }] }],
    },
    // ── FOOTER PAGES: COMPANY ──
    {
      title: "About (/About)",
      color: "#9DA3B4", dotColor: "#9DA3B4", exportPagePath: "About",
      badge: "Footer: Company · Mission + 3 pillars + 4 values",
      sections: [{ id: "about-full", title: "About — Full Page HTML", exportPagePath: "About", items: [{ label: "HTML", code: ABOUT_HTML }] }],
    },
    {
      title: "Careers (/Careers)",
      color: "#9DA3B4", dotColor: "#9DA3B4", exportPagePath: "Careers",
      badge: "Footer: Company · 4 values + 4 open positions",
      sections: [{ id: "careers-full", title: "Careers — Full Page HTML", exportPagePath: "Careers", items: [{ label: "HTML", code: CAREERS_HTML }] }],
    },
    {
      title: "Blog (/Blog)",
      color: "#9DA3B4", dotColor: "#FA982F", exportPagePath: "Blog",
      badge: "Footer: Company · Featured post + 6 article cards (static version)",
      sections: [{ id: "blog-full", title: "Blog — Full Page HTML (Static version, no React filter)", exportPagePath: "Blog", items: [{ label: "HTML", code: BLOG_HTML }] }],
    },
    {
      title: "Contact (/Contact)",
      color: "#9DA3B4", dotColor: "#F54A48", exportPagePath: "Contact",
      badge: "Footer: Company · Form + contact info + address",
      sections: [{ id: "contact-full", title: "Contact — Full Page HTML", exportPagePath: "Contact", items: [{ label: "HTML", code: CONTACT_HTML }] }],
    },
    {
      title: "Resources (/Resources)",
      color: "#9DA3B4", dotColor: "#63B3ED", exportPagePath: "Resources",
      badge: "NeuralOS Nav · 4 resource types + 4 featured articles",
      sections: [{ id: "resources-full", title: "Resources — Full Page HTML", exportPagePath: "Resources", items: [{ label: "HTML", code: RESOURCES_HTML }] }],
    },
    // ── FOOTER PAGES: LEGAL ──
    {
      title: "Privacy Policy (/PrivacyPolicy)",
      color: "#6B7C93", dotColor: "#F54A48", exportPagePath: "PrivacyPolicy",
      badge: "Footer: Legal · Effective March 15, 2026 · 13 sections",
      sections: [{ id: "privacy-policy-full", title: "Privacy Policy — Full Page HTML (summary + key sections)", exportPagePath: "PrivacyPolicy", items: [{ label: "HTML", code: PRIVACY_POLICY_HTML }] }],
    },
    {
      title: "Terms of Service (/TermsOfService)",
      color: "#6B7C93", dotColor: "#F54A48", exportPagePath: "TermsOfService",
      badge: "Footer: Legal · Effective March 15, 2026 · Cherokee County GA · 20 sections",
      sections: [{ id: "tos-full", title: "Terms of Service — Full Page HTML (summary + key terms)", exportPagePath: "TermsOfService", items: [{ label: "HTML", code: TERMS_OF_SERVICE_HTML }] }],
    },
    {
      title: "Cookie Policy (/CookiePolicy)",
      color: "#6B7C93", dotColor: "#F54A48", exportPagePath: "CookiePolicy",
      badge: "Footer: Legal · Effective March 15, 2026 · 4 cookie categories",
      sections: [{ id: "cookie-policy-full", title: "Cookie Policy — Full Page HTML", exportPagePath: "CookiePolicy", items: [{ label: "HTML", code: COOKIE_POLICY_HTML }] }],
    },
    {
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-6">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full border mb-6 font-mono text-xs uppercase tracking-widest"
            ...
            Master Export Hub · v4 — ALL PAGES
          </div>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full font-mono text-xs"
            ...
            ✓ Every nav + footer page exported: 20+ pages · All 3 navbars · Calculator · Legal
          </div>
        </div>
        ...
        <div className="rounded-2xl p-8 mb-10 text-center relative overflow-hidden"
          ...
          <div className="relative">
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span className="font-display text-xl font-bold text-white">Export Entire Site (v4 — ALL PAGES)</span>
            </div>
            <p className="text-sm mb-6 max-w-xl mx-auto" style={{ color: "rgba(255,255,255,0.55)" }}>
              Downloads a <strong className="text-white">ZIP with every single page</strong>: Brand Home, Convert, Attract, Calculator, How It Works, Revenue Leaks, Results, Platform, Roofing, Features, Integrations, Case Studies, Blog, About, Careers, Contact, Resources, Privacy Policy, Terms of Service, Cookie Policy + all assets.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              >
                ...
                {downloading ? "Building ZIP..." : "Download v4 — ALL PAGES ZIP"}
              </button>
              <button
        ...
        <div className="mt-10 p-5 rounded-xl text-center" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
          <p className="text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>
            ShiFt NeuralOS™ Master Export v4 · ALL PAGES · HTML extracted from live React source files · Last updated March 2026
          </p>
        </div>
      </div>
    </div>
